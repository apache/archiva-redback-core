...
public class LdapGroupMappingUpdateRequest
    implements Serializable
{

    private List<LdapGroupMapping> ldapGroupMapping;

    public LdapGroupMappingUpdateRequest()
    {
        // no op
    }
    ...
    public List<LdapGroupMapping> getLdapGroupMapping()
    {
        ...
        {
            this.ldapGroupMapping = new ArrayList<LdapGroupMapping>();
        }
        return ldapGroupMapping;
    }

    public void setLdapGroupMapping( List<LdapGroupMapping> ldapGroupMapping )
    {
    ...
    public String toString()
    {
        ...
        sb.append( "ldapGroupMapping=" ).append( ldapGroupMapping );
        sb.append( '}' );
        return sb.toString();
    }
}
